...
@section('content')
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about_content mt-45 wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        ...
                        <p>Rumah Makan Sate Balibul didirikan dengan cinta dan dedikasi untuk memperkenalkan kelezatan sate kambing Indonesia ke seluruh penjuru. Pendiri kami, Ibu Tabita dan Bapak Ali, adalah seorang pengusaha yang telah menjalani perjalanan kuliner mereka dengan kehidupan dan warisan yang kuat. Mereka membawa pengetahuan mereka dalam meracik dan memanggang sate kambing yang sempurna, dengan resep warisan keluarga yang telah turun-temurun.</p>
                        <ul class="social">
        ...
        <div class="container">
            ...
            <div id="tabs-1" class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_menu text-center mt-30 wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        <div class="menu_image">
                            <img src="images/sate solo.jpg" height="200" width="250"  alt="coffee">
                        </div>
                        <div class="menu_content">
                            <h4 class="menu_title">Sate Khas Solo</h4>
                            <p>Campuran daging kambing balibul dan lemak yang dibakar dengan celupan bumbu kecap. Disajikan dengan kecap khas Solo dengan cita rasa manis dan gurih dan bahan pelengkap lainnya</p>
                        </div>
                    </div> <!-- single menu -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_menu text-center mt-30 wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        ...
                        <div class="menu_content">
                            ...
                            <p>Campuran daging kambing balibul dan lemak yang dibakar tanpa menggunakan bumbu. Disajikan dengan kecap khas Tegaldan bahan pelengkap lainnya</p>
                        </div>
                    </div> <!-- single sate -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_menu text-center mt-30 wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        ...
                        <div class="menu_content">
                            ...
                            <p>Campuran daging kambing balibul dan lemak yang dibakar dengan celupan bumbu gurih. Disajikan dengan kuah gulai dan bahan pelengkap lainnya</p>
                        </div>
                    </div> <!-- single sate -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-9">
                    ...
                    <div class="single_customer d-sm-flex align-items-center mt-30">
                        ...
                        <div class="customer_content media-body">
                            <div class="customer_content_wrapper media-body">
                                ...
                                <p>“Mudah dijangkau dengan transportasi umum maupun pribadi. Untuk masalah harga, relatif ya..kan kambing empuk...enak kok satenya”</p>
                                <ul class="star">
                                    <li><i class="lni lni-star-filled"></i></li>
                                    <li><i class="lni lni-star-filled"></i></li>
                                    <li><i class="lni lni-star-filled"></i></li>
                    ...
                    <div class="single_customer d-sm-flex align-items-center mt-30">
                        ...
                        <div class="customer_content media-body">
                            <div class="customer_content_wrapper media-body">
                                ...
                                <p>“Banyak pilihan sate. Buat lidah saya kecap nya terlalu manis tapi rasanya Enak . Good lah”</p>
                                <ul class="star">
                                    <li><i class="lni lni-star-filled"></i></li>
                                    <li><i class="lni lni-star-filled"></i></li>
                                    <li><i class="lni lni-star-filled"></i></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="single_form text-center mt-30">
                                <button type="submit" value="Send Message" class="main-btn">SUBMIT</button>
                            </div> <!-- single form -->
                        </div>
                    </div> <!-- row -->
                </form>
    ...
    <!--====== FRANCHISE PART START======-->

    <section id="franchise" class="franshise_area">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center pb-50">
                        <h4 class="title">FRANCHISE</h4>
                        <span class="line">
                            <span class="box"></span>
                        </span>
                    </div> <!-- section title -->
            ...
            <div class="row justify-content-center pb-90">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_franchise mt-30 wow fadeInLeftBig">
                        <div class="franchise_location">
                            <h4 class="text-wrapper">Sate Balibul Pusat</h4></li>
                        </div>
                        <div class="franchise_content">
                            <p>Jl. A. Yani No. 219 Pabelan Kartasura</p>
                            <a href="https://wa.me/081326598126">Telp. 081326598126</a>
                        </div>
                    </div> <!-- single franchise -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_franchise mt-30 wow fadeInLeftBig">
                        <div class="franchise_location">
                            <h4 class="text-wrapper">Sate Balibul Yogya</h4></li>
                        </div>
                        <div class="franchise_content">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_franchise mt-30 wow fadeInLeftBig">
                        <div class="franchise_location">
                            <h4 class="text-wrapper">Sate Balibul Magelang</h4></li>
                        </div>
                        <div class="franchise_content">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_franchise mt-30 wow fadeInLeftBig">
                        <div class="franchise_location">
                            <h4 class="text-wrapper">Sate Balibul Salatiga</h4></li>
                        </div>
                        <div class="franchise_content">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_franchise mt-30 wow fadeInLeftBig">
                        <div class="franchise_location">
                            <h4 class="text-wrapper">Sate Balibul Karanganyar</h4></li>
                        </div>
                        <div class="franchise_content">
                            <p>Jl. Lawu No. 136, Bejen Karanganyar</p>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_franchise mt-30 wow fadeInLeftBig">
                        <div class="franchise_location">
                            <h4 class="text-wrapper">Sate Balibul Sukoharjo</h4></li>
                        </div>
                        <div class="franchise_content">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_franchise mt-30 wow fadeInLeftBig">
                        <div class="franchise_location">
                            <h4 class="text-wrapper">Sate Balibul Wates</h4></li>
                        </div>
                        <div class="franchise_content">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single_franchise mt-30 wow fadeInLeftBig">
                        <div class="franchise_location">
                            <h4 class="text-wrapper">Sate Balibul Resta Pendopo</h4></li>
                        </div>
                        <div class="franchise_content">
                            <p>Rest Area Pendopo KM 456, Tol Semarang - Solo Side A UG-010 Salatiga</p>
                            <a href="https://wa.me/082121440470">Telp. 082121440470</a>
                        </div>
                    </div> <!-- single franchise -->
                </div>
            </div> <!-- row -->
        ...
        <div class="contact_map">
            <div class="gmap_canvas">                            
                <iframe id="gmap_canvas" src="https://www.google.com/maps/d/u/0/embed?mid=13ln3xA3LVQnkn2EsGw1tlwt5_MPvooc&ehbc=2E312F&noprof=1" width="640" height="480" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
            </div>
        </div> <!-- contact map -->
    </section>
